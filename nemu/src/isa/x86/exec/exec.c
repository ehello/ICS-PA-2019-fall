...
/* 0x80, 0x81, 0x83 */
make_group(gp1,
    EXW(add,1), EXW(or,1), EMPTY, EMPTY,
...
/* 0xf6, 0xf7 */
make_group(gp3,
    IDEX(test_I,test), EMPTY, EX(not), EX(neg),//think about why
...
/*2 byte_opcode_table */
  ...
  /* 0x94 */	IDEX(setcc_E,setcc), IDEXW(setcc_E,setcc,1), IDEXW(setcc_E,setcc,1), IDEXW(setcc_E,setcc,1),
